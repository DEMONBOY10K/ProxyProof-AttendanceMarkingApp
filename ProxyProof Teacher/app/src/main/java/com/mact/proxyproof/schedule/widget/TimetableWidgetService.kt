...
//        Log.i("TESTTT", "onDestroy()")
    ...
    override fun getViewAt(position: Int): RemoteViews {
        ...
        val views = RemoteViews(mContext.packageName, R.layout.widget_course_card).apply {
            ...
            setTextViewText(R.id.textView_widget_courseName, mWidgetItems[position].courseSubject)
            setTextViewText(R.id.textView_widget_coursePlace, mWidgetItems[position].courseSection)
        }
